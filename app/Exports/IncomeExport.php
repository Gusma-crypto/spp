...
class IncomeExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithStyles, WithEvents
{
    protected $from;
    protected $to;
    protected $total = 0;
    ...
    {
        $data = Income::select('date', 'total_income', 'note')
        ...
        $this->total = $data->sum(function ($item) {
            return $this->parseRupiah($item->total_income);
        });
    ...
    {
        return ['Tanggal', 'Total Pemasukan', 'Keterangan'];
    }
