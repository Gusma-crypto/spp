...
@section('content')
    <div class="card-body">
        <form action="{{ route('master.expense.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-3">
                <label for="total_expense" class="form-label"><span class="text-danger">* </span>Jumlah Pengeluaran</label>
            ...
            <div class="mb-3">
                ...
                <textarea name="note" id="note" class="form-control" cols="30" rows="5" required></textarea>
            </div>
